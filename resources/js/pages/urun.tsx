...
import { Heart, Truck, Shield, MapPin, Calendar, User, Mail, MoreVertical, Star, Users, GraduationCap, Eye, Plus, Edit, Trash2, Phone, Globe, Lock, Users as UsersIcon, ArrowLeft, Share2, MessageCircle, Tag, CheckCircle, Image as ImageIcon } from 'lucide-react';
import { useState } from 'react';

export default function Urun() {
    const { auth } = usePage<SharedData>().props;
    const { product, seller, viewer } = usePage<{ product: any; seller: any; viewer: any }>().props;
